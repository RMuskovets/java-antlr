...
CHE_API=https://codenvy.io/api
CHE_IS_DEV_MACHINE=true
CHE_LOCAL_CONF_DIR=/mnt/che/conf
CHE_LOGS_DIR_SETTER=
CHE_MACHINE_NAME=dev-machine
CHE_PROJECTS_ROOT=/projects
CHE_WORKSPACE_ID=workspaceelkpm4787pecswka
CODENVY_SYNC_PUB_KEY=$'ssh-rsa  root@fd3d655332a4\n'
COLUMNS=203
DIRSTACK=()
EUID=1000
EXEC_AGENT_LOGS_DIR_SETTER='export EXEC_AGENT_LOGS_DIR="$HOME/che/exec-agent/logs"'
GROUPS=()
...
HISTSIZE=1000
HOME=/home/user
HOSTNAME=b5415264538c
HOSTTYPE=x86_64
IFS=$' \t\n'
JAVA_HOME=/usr/lib/jvm/java-1.8.0-openjdk-amd64
JAVA_OPTS='-Xms256m -Xmx2048m -XX:+UseG1GC -XX:+UseStringDeduplication -Djava.security.egd=file:/dev/./urandom '
LANG=en_US.UTF-8
...
MAILCHECK=60
MAVEN_OPTS='-Xms256m -Xmx2048m -XX:+UseG1GC -XX:+UseStringDeduplication -Djava.security.egd=file:/dev/./urandom '
MAVEN_VERSION=3.3.9
OLDPWD=/projects
OPTERR=1
OPTIND=1
...
UID=1000
USER_TOKEN=machine5me5zppxi2z7iivx9fiu06yousa1fx6kllrexqqf6826evx1cldcgt2xyrs3l9b6tee26qqj92c6a1eoy50184gdf0osslz0q0o55ceohuhn4azlgy8k6924y7t7bya4
_=set
